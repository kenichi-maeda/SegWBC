...
# Full UNet++
def unetpp_model(input_size=(128, 128, 1)):
    ...
    x3_0 = conv_block(p2, 256, dropout=True)
    p3 = MaxPooling2D((2, 2))(x3_0)

    x4_0 = conv_block(p3, 512)

    # Nested decoder (skip pathways)
    x3_1 = conv_block(Concatenate()([x3_0, UpSampling2D((2, 2))(x4_0)]), 256)
    x2_1 = conv_block(Concatenate()([x2_0, UpSampling2D((2, 2))(x3_1)]), 128)
    x1_1 = conv_block(Concatenate()([x1_0, UpSampling2D((2, 2))(x2_1)]), 64)
    x0_1 = conv_block(Concatenate()([x0_0, UpSampling2D((2, 2))(x1_1)]), 32)

    x2_2 = conv_block(Concatenate()([x2_0, x2_1, UpSampling2D((2, 2))(x3_1)]), 128)
    x1_2 = conv_block(Concatenate()([x1_0, x1_1, UpSampling2D((2, 2))(x2_2)]), 64)
    x0_2 = conv_block(Concatenate()([x0_0, x0_1, UpSampling2D((2, 2))(x1_2)]), 32)

    x1_3 = conv_block(Concatenate()([x1_0, x1_1, x1_2, UpSampling2D((2, 2))(x2_2)]), 64)
    x0_3 = conv_block(Concatenate()([x0_0, x0_1, x0_2, UpSampling2D((2, 2))(x1_3)]), 32)

    x0_4 = conv_block(Concatenate()([x0_0, x0_1, x0_2, x0_3, UpSampling2D((2, 2))(x1_3)]), 32)
...
def main():
    ...
    start = time.time()
    history = model.fit(train_X, train_Y, epochs=10, batch_size=2, validation_data=(val_X, val_Y))
